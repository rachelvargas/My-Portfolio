...
function cityDetails() {
    ...
    let url = `https://world-geo-data.p.rapidapi.com/cities/5128581/${this.country.code}`; //look for cities with this country ID or code
    ...
    fetch(url)
        ...
        .then(city => {
            if (json.checked) {
                document.body.innerText = JSON.stringify(city);
                return;
            }
